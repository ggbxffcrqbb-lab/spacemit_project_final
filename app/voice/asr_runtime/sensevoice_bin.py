...
class SenseVoiceSmall:
    def __init__(
        ...
        prefer_optimized_model: bool = True,
        batch_size: int = 1,
        ...
        **kwargs,
        ...
        optimized_model_file = os.path.join(model_dir, "model_quant_optimized.onnx")
        fallback_model_file = os.path.join(model_dir, "model_quant.onnx")
        model_file = fallback_model_file
        if prefer_optimized_model and os.path.exists(optimized_model_file):
        ...
        self.prefer_optimized_model = prefer_optimized_model
        self.using_optimized_model = model_file == optimized_model_file
